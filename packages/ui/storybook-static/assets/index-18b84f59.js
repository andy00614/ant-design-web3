...
let no = class {
  ...
  get styleSheet() {
    ...
    if (wr && t === void 0) {
      ...
      n && (t = _r.get(r)),
        t === void 0 &&
          ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && _r.set(r, t));
    }
    return t;
  }
  toString() {
...
const Uo = (e) => new no(typeof e == 'string' ? e : e + '', void 0, vr),
  M = (e, ...t) => {
    const r =
      e.length === 1
        ? e[0]
...
let $t = class extends HTMLElement {
  ...
  _$EO(t, r, n = Ee) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const s = (
        ((o = n.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== void 0
          ? n.converter
          : sr
    ...
    t !== void 0 &&
      (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || io)(this[t], r)
        ? (this._$AL.has(t) || this._$AL.set(t, r),
          n.reflect === !0 &&
            this._$El !== t &&
            (this._$EC === void 0 && (this._$EC = new Map()), this._$EC.set(t, n)))
        : (o = !1)),
  ...
  update(t) {
    this._$EC !== void 0 &&
      (this._$EC.forEach((r, n) => this._$EO(n, this[n], r)), (this._$EC = void 0)),
      this._$Ek();
  }
  updated(t) {}
  firstUpdated(t) {}
...
const ue = window,
  ...
  ao = Array.isArray,
  zo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == 'function',
  _e = `[ 	
\f\r]`,
  ...
  for (let a = 0; a < r; a++) {
    ...
    i +=
      s === Rt
        ? l + Ho
        : b >= 0
          ? (n.push(c), l.slice(0, b) + lr + l.slice(b) + rt + u)
          : l + rt + (b === -2 ? (n.push(void 0), a) : u);
  }
...
function kt(e, t, r = e, n) {
  ...
  return (
    (l == null ? void 0 : l.constructor) !== c &&
      ...
      n !== void 0
        ? (((s = (a = r)._$Co) !== null && s !== void 0 ? s : (a._$Co = []))[n] = l)
        : (r._$Cl = l)),
...
class Zo {
  ...
  u(t) {
    ...
    const {
      ...
      i = ((r = t == null ? void 0 : t.creationScope) !== null && r !== void 0 ? r : ft).importNode(
        n,
        !0,
      );
    ut.currentNode = i;
  ...
  v(t) {
    ...
    for (const n of this._$AV)
      n !== void 0 &&
        (n.strings !== void 0 ? (n._$AI(t, n, r), (r += n.strings.length - 2)) : n._$AI(t[r])),
        r++;
  }
}
class Jt {
  ...
  get _$AU() {
    var t, r;
    return (r = (t = this._$AM) === null || t === void 0 ? void 0 : t._$AU) !== null && r !== void 0
      ? r
      : this._$Cp;
  }
  get parentNode() {
  ...
  setConnected(t) {
    var r;
    this._$AM === void 0 &&
      ((this._$Cp = t), (r = this._$AP) === null || r === void 0 || r.call(this, t));
  }
}
class ve {
...
class Yo extends ve {
  ...
  handleEvent(t) {
    ...
    typeof this._$AH == 'function'
      ? this._$AH.call(
          (n = (r = this.options) === null || r === void 0 ? void 0 : r.host) !== null &&
            n !== void 0
            ? n
            : this.element,
          t,
...
Nr == null || Nr(Kt, Jt),
  ((Ae = ue.litHtmlVersions) !== null && Ae !== void 0 ? Ae : (ue.litHtmlVersions = [])).push(
    '2.8.0',
  );
const Go = (e, t, r) => {
  var n, o;
...
(A.finalized = !0),
  ...
  (Oe = globalThis.litElementHydrateSupport) === null ||
    Oe === void 0 ||
    Oe.call(globalThis, { LitElement: A });
const Br = globalThis.litElementPolyfillSupport;
Br == null || Br({ LitElement: A });
((ke = globalThis.litElementVersions) !== null && ke !== void 0
  ? ke
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const tn = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 },
  en =
    (e) =>
...
const uo = (e, t, r) => Math.min(Math.max(r, e), t),
  H = { duration: 0.3, delay: 0, endDelay: 0, repeat: 0, easing: 'ease' },
...
function ln(e, t = an(e.length), r = it) {
  ...
  return (
    ...
    (i) => {
      ...
      return (a = sn(r, s)(a)), mo(e[s], e[s + 1], a);
    }
  );
}
...
class vo {
  constructor(
    ...
    const d = ln(r, l, Et(n) ? n.map(Ur) : it);
    (this.tick = (b) => {
      var h;
      i = i;
      let u = 0;
      this.pauseTime !== void 0 ? (u = this.pauseTime) : (u = (b - this.startTime) * this.rate),
        (this.t = u),
        (u /= 1e3),
        (u = Math.max(u - i, 0)),
        this.playState === 'finished' && this.pauseTime === void 0 && (u = this.totalDuration);
      ...
      const y = u >= this.totalDuration ? 1 : Math.min($, 1),
        v = d(this.easing(y));
      t(v),
        this.pauseTime === void 0 && (this.playState === 'finished' || u >= this.totalDuration + s)
...
function bo(e) {
  return Te.has(e) || Te.set(e, { transforms: [], values: new Map() }), Te.get(e);
}
function pn(e, t) {
...
vn.forEach((e) => {
  wn.forEach((t) => {
    fe.push(e + t), qt.set(yr(e + t), bn[e]);
  });
});
...
const Pe = (e, t) => document.createElement('div').animate(e, t),
  Hr = {
    ...
    finished: () => !!Pe({ opacity: [0, 1] }, { duration: 0.001 }).finished,
    linearEasing: () => {
      try {
...
const _n = 0.015,
  ...
  zr = (e, t) =>
    It(e) ? (Ct.linearEasing() ? `linear(${On(e, t)})` : H.easing) : po(e) ? kn(e) : e,
...
function Sn(e, t, r, n = {}, o) {
  ...
  const w = hr(t),
    ...
    I = qt.get(w);
  return (
    xo(k.animation, !(cr(h) && k.generator) && n.record !== !1),
    () => {
      const R = () => {
        var P, F;
        return (F =
          (P = Xt.get(e, w)) !== null && P !== void 0 ? P : I == null ? void 0 : I.initialValue) !==
          null && F !== void 0
          ? F
          : 0;
      };
      ...
      if (
        (dr(w) && (Ct.cssRegisterProperty() ? An(w) : (v = !1)),
        y && !Ct.linearEasing() && (It(h) || (Et(h) && h.some(It))) && (v = !1),
        v)
      ) {
        I && (T = T.map((Z) => (me(Z) ? I.toDefaultUnit(Z) : Z))),
          T.length === 1 && (!Ct.partialKeyframes() || s) && T.unshift(R());
        const P = {
          delay: zt.ms(c),
          duration: zt.ms(l),
          endDelay: zt.ms(d),
        ...
        (a = e.animate({ [w]: T, offset: g, easing: Et(h) ? h.map((Z) => zr(Z, l)) : void 0 }, P)),
          a.finished ||
            (a.finished = new Promise((Z, V) => {
        ...
        a.finished
          ...
          .catch(go),
          $ || (a.playbackRate = 1.000001);
      } else if (o && y)
        (T = T.map((P) => (typeof P == 'string' ? parseFloat(P) : P))),
          T.length === 1 && T.unshift(parseFloat(R())),
          (a = new o(
            (P) => {
              Xt.set(e, w, z ? z(P) : P);
            },
            T,
            Object.assign(Object.assign({}, n), { duration: l, easing: h }),
          ));
      else {
      ...
      return (
        s && i(e, t, T, { duration: l, delay: c, easing: h, repeat: b, offset: g }, 'motion-one'),
        k.setAnimation(a),
        a
      );
    }
...
function Ln(e, t) {
  ...
  return (
    typeof e == 'string'
      ? t
        ? (((r = t[e]) !== null && r !== void 0) || (t[e] = document.querySelectorAll(e)),
          (e = t[e]))
...
const Nn = (e) => e(),
  $o = (e, t, r = H.duration) =>
    new Proxy({ animations: e.map(Nn).filter(Boolean), duration: r, options: t }, Dn),
  Bn = (e) => e.animations[0],
  Dn = {
    get: (e, t) => {
      const r = Bn(e);
      switch (t) {
        ...
        case 'finished':
          return (
            e.finished || (e.finished = Promise.all(e.animations.map(Un)).catch(go)), e.finished
          );
        case 'stop':
          return () => {
  ...
  (e.isValid = function (o) {
    ...
    (e.getPenaltyN1 = function (o) {
      ...
      for (let b = 0; b < i; b++) {
        ...
        for (let h = 0; h < i; h++) {
          let u = o.get(b, h);
          u === c ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (c = u), (a = 1)),
            (u = o.get(h, b)),
            u === d ? l++ : (l >= 5 && (s += t.N1 + (l - 5)), (d = u), (l = 1));
        }
...
(function (e) {
  const t = W,
    ...
    a = t.getBCHDigit(s);
  function l(h, u, p) {
    for (let g = 1; g <= 40; g++) if (u <= e.getCapacity(g, p, h)) return g;
  }
  function c(h, u) {
  ...
  function b(h, u) {
    for (let p = 1; p <= 40; p++) if (d(h, p) <= e.getCapacity(p, u, o.MIXED)) return p;
  }
  (e.from = function (u, p) {
...
const ur = W,
  So = 1335,
  ei = 21522,
  Zr = ur.getBCHDigit(So);
Mo.getEncodedBits = function (t, r) {
  const n = (t.bit << 3) | r;
  let o = n << 10;
  for (; ur.getBCHDigit(o) - Zr >= 0; ) o ^= So << (ur.getBCHDigit(o) - Zr);
  return ((n << 10) | o) ^ ei;
};
var Ro = {};
const ri = at;
...
(function (e) {
  ...
  function d(f, y, v) {
    ...
    let k;
    for (; (k = f.exec(v)) !== null; )
      w.push({ data: k[0], index: k.index, mode: y, length: k[0].length });
    return w;
  }
  function b(f) {
    ...
    return (
      a.isKanjiModeEnabled()
        ? ((w = d(s.BYTE, t.BYTE, f)), (k = d(s.KANJI, t.KANJI, f)))
        : ((w = d(s.BYTE_KANJI, t.BYTE, f)), (k = [])),
      y
        .concat(v, w, k)
        .sort(function (R, T) {
    ...
    for (let v = 0; v < f.length; v++) {
      ...
      switch (w.mode) {
        case t.NUMERIC:
          ...
          break;
        case t.ALPHANUMERIC:
          y.push([w, { data: w.data, mode: t.BYTE, length: w.length }]);
          break;
        case t.KANJI:
          y.push([w, { data: w.data, mode: t.BYTE, length: c(w.data) }]);
          break;
        case t.BYTE:
          y.push([{ data: w.data, mode: t.BYTE, length: c(w.data) }]);
      }
    }
    return y;
  }
    ...
    for (let I = 0; I < f.length; I++) {
      ...
      for (let z = 0; z < R.length; z++) {
        ...
        for (let Z = 0; Z < k.length; Z++) {
          const V = k[Z];
          v[V] && v[V].node.mode === P.mode
            ? ((w[V][F] = h(v[V].lastCount + P.length, P.mode) - h(v[V].lastCount, P.mode)),
              (v[V].lastCount += P.length))
            : (v[V] && (v[V].lastCount = P.length),
              (w[V][F] = h(P.length, P.mode) + 4 + t.getCharCountIndicator(P.mode, y)));
        }
      }
      k = T;
    }
...
function Oi(e, t, r) {
  ...
  let w = 0,
    k,
    I;
  for (k = 0; k < f; k++) for (I = 0; I < s; I++) k < g[I].length && (v[w++] = g[I][k]);
  for (k = 0; k < h; k++) for (I = 0; I < s; I++) v[w++] = $[I][k];
  return v;
}
function ki(e, t, r, n) {
  let o;
...
`,
  ...
  return (
    ...
    gr.applyMask(n, l),
    Ne(l, r, n),
    { modules: l, version: t, errorCorrectionLevel: r, maskPattern: n, segments: o }
  );
}
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    !l && !i && (i = !0),
      e[a]
        ? (s++,
          (a > 0 && l > 0 && e[a - 1]) ||
            ((n += i ? Be('M', l + r, 0.5 + c + r) : Be('m', o, 0)), (o = 0), (i = !1)),
...
No.render = function (t, r, n) {
  const o = Ii.getOptions(r),
    ...
    a = i + o.margin * 2,
    l = o.color.light.a
      ? '<path ' + Vr(o.color.light, 'fill') + ' d="M0 0h' + a + 'v' + a + 'H0z"/>'
      : '',
    c = '<path ' + Vr(o.color.dark, 'stroke') + ' d="' + Ti(s, i, o.margin) + '"/>',
    d = 'viewBox="0 0 ' + a + ' ' + a + '"',
    h =
...
var Si = Object.defineProperty,
  ...
  qr = (e, t, r) =>
    t in e ? Si(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[t] = r),
  De = (e, t) => {
    for (var r in t || (t = {})) Ri.call(t, r) && qr(e, r, t[r]);
    if (Kr) for (var r of Kr(t)) Li.call(t, r) && qr(e, r, t[r]);
    return e;
  };
function Ni() {
  var e;
...
var Di = Object.defineProperty,
  ...
  wt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Ui(t, r) : t, i = e.length - 1, s; i >= 0; i--)
...
let Q = class extends A {
  ...
  render() {
    ...
    return (
      ...
      m`<button class="${G(e)}" ?disabled="${this.disabled}" @click="${this.onClick}">${
        this.iconLeft
...
(Q.styles = [_.globalCss, Bi]),
  wt([C({ type: Boolean })], Q.prototype, 'disabled', 2),
  wt([C()], Q.prototype, 'iconLeft', 2),
  wt([C()], Q.prototype, 'iconRight', 2),
  wt([C()], Q.prototype, 'onClick', 2),
  wt([C()], Q.prototype, 'variant', 2),
  (Q = wt([O('wcm-button')], Q));
...
(Lt.styles = [_.globalCss, ji]),
  Ue([C({ type: Boolean })], Lt.prototype, 'disabled', 2),
  Ue([C()], Lt.prototype, 'variant', 2),
  (Lt = Ue([O('wcm-button-big')], Lt));
...
var qi = Object.defineProperty,
  ...
  Ji = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Yi(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
var Qi = Object.defineProperty,
  ...
  ts = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Xi(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
    return n && o && Qi(t, r, o), o;
  };
...
let ct = class extends A {
  ...
  render() {
    ...
    return m`<header class="${G(e)}">${t ? this.backBtnTemplate() : null} ${r} ${
      this.onAction ? this.actionBtnTemplate() : null
    }</header>`;
  }
};
(ct.styles = [_.globalCss, is]),
  Nt([C()], ct.prototype, 'title', 2),
  Nt([C()], ct.prototype, 'onAction', 2),
  Nt([C()], ct.prototype, 'actionIcon', 2),
  Nt([C({ type: Boolean })], ct.prototype, 'border', 2),
  (ct = Nt([O('wcm-modal-header')], ct));
const x = {
    ...
    handleMobileLinking(e) {
      ...
      function s(a) {
        let l = '';
        o ? (l = E.formatUniversalUrl(o, a, n)) : i && (l = E.formatNativeUrl(i, a, n)),
          E.openHref(l, '_self');
      }
      t && s(t);
    },
    ...
    getCachedRouterWalletPlatforms() {
      const { desktop: e, mobile: t } = E.getWalletRouterData(),
        r = !!(e != null && e.native),
...
let Bt = class extends A {
  ...
  async onChangeRoute() {
    await mt(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 })
      .finished,
      (this.view = N.state.view),
...
(Bt.styles = [_.globalCss, ls]),
  Fe([j()], Bt.prototype, 'view', 2),
  Fe([j()], Bt.prototype, 'prevView', 2),
  (Bt = Fe([O('wcm-modal-router')], Bt));
...
let re = class extends A {
  ...
  render() {
    ...
    return this.open
      ? m`<div class="${G(r)}">${t === 'success' ? S.CHECKMARK_ICON : null} ${
          t === 'error' ? S.CROSS_ICON : null
        }<wcm-text variant="small-regular">${e}</wcm-text></div>`
      : null;
  }
};
(re.styles = [_.globalCss, hs]),
  Jr([j()], re.prototype, 'open', 2),
  (re = Jr([O('wcm-modal-toast')], re));
const gs = 0.1,
  Gr = 2.5,
  J = 7;
function Ze(e, t, r) {
    ...
    generate(e, t, r) {
      ...
      l.forEach(({ x: p, y: g }) => {
        ...
        for (let v = 0; v < l.length; v += 1) {
          const w = a * (J - v * 2);
          i.push(
            L`<rect fill="${v % 2 === 0 ? n : o}" height="${w}" rx="${w * y}" ry="${
              w * y
            }" width="${w}" x="${$ + a * v}" y="${f + a * v}">`,
          );
        }
      });
      ...
      return (
        ...
        Object.entries(u)
          ...
          .forEach(([p, g]) => {
            g.forEach(([$, f]) => {
              i.push(
                L`<line x1="${p}" x2="${p}" y1="${$}" y2="${f}" stroke="${n}" stroke-width="${
                  a / (Gr / 2)
  ...
  render() {
    ...
    return m`<div style="${`width: ${this.size}px`}" class="${G(e)}">${
      this.walletId || this.imageUrl
        ? m`<wcm-wallet-image walletId="${D(this.walletId)}" imageId="${D(
            this.imageId,
...
(X.styles = [_.globalCss, ws]),
  vt([C()], X.prototype, 'uri', 2),
  vt([C({ type: Number })], X.prototype, 'size', 2),
  vt([C()], X.prototype, 'imageId', 2),
  vt([C()], X.prototype, 'walletId', 2),
  vt([C()], X.prototype, 'imageUrl', 2),
  (X = vt([O('wcm-qrcode')], X));
...
(oe.styles = [_.globalCss, ys]),
  Qr([C()], oe.prototype, 'onChange', 2),
  (oe = Qr([O('wcm-search-input')], oe));
...
(Dt.styles = [_.globalCss, Os]),
  Ke([C()], Dt.prototype, 'variant', 2),
  Ke([C()], Dt.prototype, 'color', 2),
  (Dt = Ke([O('wcm-text')], Dt));
...
let K = class extends A {
  ...
  render() {
    var e;
    return m`<button @click="${this.handleClick.bind(this)}"><div><wcm-wallet-image walletId="${
      this.walletId
    }" imageId="${D(this.imageId)}"></wcm-wallet-image><wcm-text variant="xsmall-regular">${
      (e = this.label) != null ? e : x.getWalletName(this.name, !0)
    }</wcm-text>${this.sublabelTemplate()}</div></button>`;
  }
};
(K.styles = [_.globalCss, Ts]),
  tt([C()], K.prototype, 'onClick', 2),
  tt([C()], K.prototype, 'name', 2),
  tt([C()], K.prototype, 'walletId', 2),
  tt([C()], K.prototype, 'label', 2),
  tt([C()], K.prototype, 'imageId', 2),
  tt([C({ type: Boolean })], K.prototype, 'installed', 2),
  tt([C({ type: Boolean })], K.prototype, 'recent', 2),
  (K = tt([O('wcm-wallet-button')], K));
  ...
  render() {
    ...
    return m`${
      t.length
        ...
        : S.WALLET_PLACEHOLDER
    }`;
  }
};
(bt.styles = [_.globalCss, Ss]),
  ne([C()], bt.prototype, 'walletId', 2),
  ne([C()], bt.prototype, 'imageId', 2),
  ne([C()], bt.prototype, 'imageUrl', 2),
  (bt = ne([O('wcm-wallet-image')], bt));
...
let Ye = class extends A {
  ...
  render() {
    const { recomendedWallets: e } = U.state,
      t = [...e, ...e],
      r = E.RECOMMENDED_WALLET_AMOUNT * 2;
...
let et = class extends A {
  ...
  render() {
    ...
    return m`<div class="${G(e)}">${this.svgLoaderTemplate()}<wcm-wallet-image walletId="${D(
      this.walletId,
    )}" imageId="${D(
      this.imageId,
...
(et.styles = [_.globalCss, Zs]),
  yt([C()], et.prototype, 'walletId', 2),
  yt([C()], et.prototype, 'imageId', 2),
  yt([C({ type: Boolean })], et.prototype, 'isError', 2),
  yt([C({ type: Boolean })], et.prototype, 'isStale', 2),
  yt([C()], et.prototype, 'label', 2),
  (et = yt([O('wcm-connector-waiting')], et));
const At = {
    manualWallets() {
      var e, t;
      ...
      return (t = E.isMobile()
        ...
        : s == null
          ? void 0
          : s.map(({ id: a, name: l, links: c }) => ({ id: a, name: l, desktop: c, links: c }))) !=
        null
        ? t
        : [];
    },
  ...
  st = {
    ...
    manualWalletsTemplate() {
      return At.manualWallets().map(
        (e) =>
          m`<wcm-wallet-button walletId="${e.id}" name="${e.name}" .onClick="${() =>
    ...
    recomendedWalletsTemplate(e = !1) {
      return At.recomendedWallets(e).map(
        (t) =>
          m`<wcm-wallet-button name="${t.name}" walletId="${t.id}" imageId="${
            t.image_id
    ...
    recentWalletTemplate() {
      ...
      if (e)
        return m`<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${D(
          e.image_id,
        )}" .recent="${!0}" .onClick="${() => this.onConnecting(e)}"></wcm-wallet-button>`;
    },
  },
    ...
    return m`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
      ...
      l
        ? m`<wcm-modal-footer><div class="wcm-desktop-title">${
            ...
            s ? m`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>` : null
  ...
  render() {
    ...
    return e ?? t
      ? m`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
          ...
          t ? m`<a href="${t}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>` : null
        }</wcm-text></div>`
      : null;
  }
};
...
let Qe = class extends A {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="Connect your wallet" .onAction="${
      this.onQrcode
    }" .actionIcon="${S.QRCODE_ICON}"></wcm-modal-header>${
      l
      ...
      window.addEventListener(
        ...
        (e) => {
          ...
          e.key === 'Escape'
            ? ce.close()
            : e.key === 'Tab' &&
              (((t = e.target) != null && t.tagName.includes('wcm-')) || this.containerEl.focus());
        },
...
(Ut.styles = [_.globalCss, sa]),
  Xe([j()], Ut.prototype, 'open', 2),
  Xe([j()], Ut.prototype, 'active', 2),
  (Ut = Xe([O('wcm-modal')], Ut));
...
let dt = class extends A {
  ...
  render() {
    return m`<div>${this.isRetry ? m`<slot></slot>` : null} ${
      this.isMobile
        ? m`<wcm-button .onClick="${this.onMobile}" .iconLeft="${S.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
        : null
    } ${
      this.isDesktop
        ? m`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${S.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
        : null
    } ${
      this.isWeb
        ? m`<wcm-button .onClick="${this.onWeb}" .iconLeft="${S.GLOBE_ICON}" variant="outline">Web</wcm-button>`
        : null
    }</div>`;
  }
};
(dt.styles = [_.globalCss, ca]),
  jt([C({ type: Boolean })], dt.prototype, 'isMobile', 2),
  jt([C({ type: Boolean })], dt.prototype, 'isDesktop', 2),
  jt([C({ type: Boolean })], dt.prototype, 'isWeb', 2),
  jt([C({ type: Boolean })], dt.prototype, 'isRetry', 2),
  (dt = jt([O('wcm-platform-selection')], dt));
...
let xt = class extends A {
  ...
  render() {
    return m`<div class="wcm-qr-container">${
      this.uri
        ? m`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${D(
            this.walletId,
          )}" imageId="${D(this.imageId)}"></wcm-qrcode>`
        : m`<wcm-spinner></wcm-spinner>`
    }</div>`;
  }
};
(xt.styles = [_.globalCss, pa]),
  ie([C()], xt.prototype, 'walletId', 2),
  ie([C()], xt.prototype, 'imageId', 2),
  ie([j()], xt.prototype, 'uri', 2),
  (xt = ie([O('wcm-walletconnect-qr')], xt));
...
let se = class extends A {
  ...
  onFormatAndRedirect(e) {
    const { desktop: t, name: r } = E.getWalletRouterData(),
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}" .onAction="${x.handleUriCopy}" .actionIcon="${
      S.COPY_ICON
      ...
      this,
    )}" .iconRight="${S.RETRY_ICON}">Retry</wcm-button></wcm-platform-selection></wcm-info-footer>`;
  }
};
(se.styles = [_.globalCss, $a]),
  eo([j()], se.prototype, 'isError', 2),
  (se = eo([O('wcm-desktop-connecting-view')], se));
...
let rr = class extends A {
  ...
  render() {
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(
      r,
      ...
      this.onInstall(n)}" .iconLeft="${S.ARROW_DOWN_ICON}">Download</wcm-button></wcm-info-footer>`;
  }
};
...
let ae = class extends A {
  ...
  onFormatAndRedirect(e, t = !1) {
    const { mobile: r, name: n } = E.getWalletRouterData(),
      o = r == null ? void 0 : r.native,
      i = r == null ? void 0 : r.universal;
    if (o && !t) {
  ...
  render() {
    const { name: e, id: t, image_id: r, app: n, mobile: o } = E.getWalletRouterData(),
    ...
    return m`<wcm-modal-header title="${e}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${t}" imageId="${D(
      ...
      this.onGoToAppStore(s)}" variant="ghost">App Store</wcm-button></wcm-info-footer>`;
  }
};
(ae.styles = [_.globalCss, Ia]),
  ro([j()], ae.prototype, 'isError', 2),
  (ae = ro([O('wcm-mobile-connecting-view')], ae));
      ...
      (this.searchDebounce = x.debounce((e) => {
        e.length >= 1
          ? ((this.firstFetch = !0),
            ...
            this.fetchWallets())
          : this.search &&
            ((this.search = ''), (this.endReached = this.isLastPage()), U.resetSearch());
      }));
  }
  firstUpdated() {
  ...
  async fetchWallets() {
    ...
    if (!this.endReached && (this.firstFetch || (o > ir && n.length < o)))
      try {
        ...
        await Promise.all([...l.map(async (c) => x.preloadImage(c)), E.wait(300)]),
      ...
      n
        ...
        : r.map(
            (c) =>
              m`${
                c
                  ? m`<wcm-wallet-button imageId="${c.image_id}" name="${c.name}" walletId="${
                      c.id
                    }" .onClick="${() => this.onConnect(c)}"></wcm-wallet-button>`
                  : null
              }`,
          )
    }</div><div class="wcm-placeholder-block">${
      a ? m`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>` : null
    } ${!a && this.loading ? m`<wcm-spinner></wcm-spinner>` : null}</div></wcm-modal-content>`;
  }
};
(ht.styles = [_.globalCss, Ua]),
  Wt([j()], ht.prototype, 'loading', 2),
  Wt([j()], ht.prototype, 'firstFetch', 2),
  Wt([j()], ht.prototype, 'search', 2),
  Wt([j()], ht.prototype, 'endReached', 2),
  (ht = Wt([O('wcm-wallet-explorer-view')], ht));
...
(le.styles = [_.globalCss, Ha]),
  oo([j()], le.prototype, 'isError', 2),
  (le = oo([O('wcm-web-connecting-view')], le));
