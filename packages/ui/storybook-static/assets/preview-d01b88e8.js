...
function A() {
  if (
    !R &&
    ((R = typeof crypto < 'u' && crypto.getRandomValues && crypto.getRandomValues.bind(crypto)), !R)
  )
    throw new Error(
    ...
    if (j(t)) {
      ...
      return (
        typeof o == 'object' &&
          ...
          Object.defineProperty(e, 'view', { ...n, value: Object.create(o.constructor.prototype) }),
        e
      );
    }
    return t;
...
function p(t, e = {}) {
  let n = { ...x, ...e },
    o = function (...r) {
      ...
      if (e.implicit) {
        let _ =
          (l = '__STORYBOOK_PREVIEW__' in g ? g.__STORYBOOK_PREVIEW__ : void 0) == null
            ? void 0
            : l.storyRenders.find((a) => a.phase === 'playing' || a.phase === 'rendering');
        if (_) {
          let a = !(
      ...
      let i = U.getChannel(),
        ...
        T = {
          ...
          count: 0,
          data: { name: t, args: O },
          options: { ...n, maxDepth: c + (n.depth || 3), allowFunction: n.allowFunction || !1 },
        };
      i.emit(w, T);
    };
...
var I = (t, e) => typeof e[t] > 'u' && !(t in e),
  L = (t) => {
    ...
    return Object.entries(n)
      .filter(([s]) => !!i.test(s))
      .reduce((s, [c, d]) => (I(c, e) && (s[c] = p(c, { implicit: !0, id: o })), s), {});
  },
  v = (t) => {
    let {
      initialArgs: e,
    ...
    return (o != null && o.disable) || !n
      ...
      : Object.entries(n)
          .filter(([r, i]) => !!i.action)
          .reduce(
            (r, [i, s]) => (I(i, e) && (r[i] = p(typeof s.action == 'string' ? s.action : i)), r),
            {},
          );
  },
  F = [v, L],
  B = (t) => {
    ...
    (n != null && n.disable) ||
      Object.entries(e)
        .filter(([, o]) => typeof o == 'function' && '_isMockFunction' in o && o._isMockFunction)
        .forEach(([o, r]) => {
