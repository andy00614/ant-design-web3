import { g as Kn, c as lt, a as Zn } from './_commonjsHelpers-042e6b4d.js';
import { p as $r } from './index-4d501b15.js';
import { d as es } from './index-356e4a49.js';
import {
  d as _i,
  g as $n,
  o as ft,
...
import { R as at, r as ze } from './index-f1f749bf.js';
    ...
    (S.prototype.traverse = function (x, _) {
      ...
      (S.prototype.replace = function (x, _) {
        ...
        function Je(M) {
          var Ve, vt, Fe, ee;
          if (M.ref.remove()) {
            for (vt = M.ref.key, ee = M.ref.parent, Ve = k.length; Ve--; )
              if (((Fe = k[Ve]), Fe.ref && Fe.ref.parent === ee)) {
                if (Fe.ref.key < vt) break;
                --Fe.ref.key;
              }
          }
        }
    ...
    (p.prototype._parseMappings = function (g, b) {
      ...
      for (var E = 0; E < this._sections.length; E++)
        for (
          ...
          var L = null;
          I.name &&
            ((L = S.consumer._names.at(I.name)), this._names.add(L), (L = this._names.indexOf(L)));
          var V = {
            source: O,
        ...
        p.eachMapping(function (L) {
          if (I !== null)
            if (C < L.generatedLine) O(I, S()), C++, (v = 0);
              ...
              (b[E] = V.substr(L.generatedColumn - v)), (v = L.generatedColumn), O(I, A), (I = L);
              return;
            }
        ...
        this.walk(function (v, I) {
          (p.code += v),
            I.source !== null && I.line !== null && I.column !== null
              ? ((b !== I.source || E !== I.line || S !== I.column || C !== I.name) &&
                  y.addMapping({
                    source: I.source,
...
function cs() {
  return (
    ii ||
      ((ii = 1),
      (it.SourceMapGenerator = ki().SourceMapGenerator),
      (it.SourceMapConsumer = us().SourceMapConsumer),
      (it.SourceNode = ls().SourceNode)),
    it
  );
}
const hs = 'escodegen',
  fs = 'ECMAScript code generator',
  ps = 'http://github.com/estools/escodegen',
  ds = 'escodegen.js',
  ms = { esgenerate: './bin/esgenerate.js', escodegen: './bin/escodegen.js' },
  gs = ['LICENSE.BSD', 'README.md', 'bin', 'escodegen.js', 'package.json'],
  ys = '2.1.0',
  vs = { node: '>=6.0' },
  xs = [
    {
  ...
  Ss = { estraverse: '^5.2.0', esutils: '^2.0.2', esprima: '^4.0.1' },
  _s = { 'source-map': '~0.6.1' },
  Es = {
    acorn: '^8.0.4',
    bluebird: '^3.4.7',
...
(function (e) {
  (function () {
    var t, r, i, s, a, c, f, p, y, g, b, E, S, C, v, I, O, L, V, A, m, x, _, k, B, R;
    (a = Ci), (c = Un), (t = a.Syntax);
    function G(n) {
...
`,
    ...
    function Ln(n) {
      ...
      if (((o = n.toString()), n.source)) {
        ...
        for (l = u[1], o = '', P = !1, F = !1, d = 0, w = n.source.length; d < w; ++d)
          (T = n.source.charCodeAt(d)),
            F
              ? ((o += Mr(T, F)), (F = !1))
              : (P ? T === 93 && (P = !1) : T === 47 ? (o += '\\') : T === 91 && (P = !0),
                (o += Mr(T, F)),
                (F = T === 92));
        return '/' + o + '/' + l;
      }
    ...
    function Mn(n) {
      ...
      for (o = 0, l = n.length; o < l; ++o) {
        if (((d = n.charCodeAt(o)), d === 39)) ++w;
          ...
          u += On(d, n.charCodeAt(o + 1));
          continue;
        }
        u += String.fromCharCode(d);
      }
      if (((P = !(E === 'double' || (E === 'auto' && T < w))), (F = P ? "'" : '"'), !(P ? w : T)))
        return F + u + F;
    ...
    function Dn(n, u) {
      var o, l, d, w, T, P, F, J;
      for (o = n.split(/\r\n|[\r\n]/), P = Number.MAX_VALUE, l = 1, d = o.length; l < d; ++l) {
...
`),
    ...
    function Dr(n, u) {
      var o, l, d, w, T, P, F, J, ce, qe, He, qr, Ur, ke;
...
`,
          ...
          for (
            ...
            (d = n.trailingComments[o]),
              T ? (o === 0 ? (u = [u, p]) : (u = [u, P]), u.push(Ie(d, P))) : (u = [u, pe(Ie(d))]),
              o !== l - 1 &&
                !he(K(u).toString()) &&
                (u = [
                  u,
...
` && d++;
    ...
    function jr(n) {
      var u = n.value,
        o = '';
      return u.async && (o += rt(u, !n.computed)), u.generator && (o += St(u) ? '*' : ''), o;
    }
        ...
        return (
          ...
          n.expression
            ? (u.push(v),
              ...
              u.push(o))
            : u.push(this.maybeBlock(n.body, In)),
          u
        );
      }),
...
` && (d = ['{']),
                  d.push(l)));
              var T, P, F, J;
              for (J = ee, u & ue && (J |= ie), T = 0, P = n.body.length; T < P; ++T)
                k &&
                  (T === 0 &&
...
` && (d = ['{'])),
        ...
        DirectiveStatement: function (n, u) {
          return A.raw && n.raw ? n.raw + this.semicolon(u) : Fn(n.directive) + this.semicolon(u);
        },
                  ...
                  (n.specifiers.length === 0
                    ...
                    : n.specifiers[0].type === t.ExportBatchSpecifier
                      ...
                      : ((o = U(o, '{')),
                        ae(function (w) {
                          var T, P;
                          for (o.push(C), T = 0, P = n.specifiers.length; T < P; ++T)
                            o.push(w),
        ...
        ExpressionStatement: function (n, u) {
          ...
          function T(P) {
            var F, J, ce;
            if (P.slice(0, 5) !== 'async' || !c.code.isWhiteSpace(P.charCodeAt(5))) return !1;
            for (J = 6, ce = P.length; J < ce && c.code.isWhiteSpace(P.charCodeAt(J)); ++J);
                ...
                n.specifiers[l].type === t.ImportNamespaceSpecifier
                  ...
                  : (o.push(v + '{'),
                    n.specifiers.length - l === 1
                      ...
                      : (ae(function (w) {
                          var T, P;
                          for (o.push(C), T = l, P = n.specifiers.length; T < P; ++T)
                            o.push(w),
                              o.push(d.generateExpression(n.specifiers[T], r.Sequence, M)),
                              T + 1 < P && o.push(',' + C);
                        }),
...
`),
        ...
        SwitchCase: function (n, u) {
          ...
          return (
            ae(function () {
              for (
                n.test
                  ? (o = [U('case', P.generateExpression(n.test, r.Sequence, M)), ':'])
                  : (o = ['default:']),
                  d = 0,
                  w = n.consequent.length,
                  w &&
                    n.consequent[0].type === t.BlockStatement &&
                    ((l = P.maybeBlock(n.consequent[0], ee)), o.push(l), (d = 1)),
        ...
        ForStatement: function (n, u) {
          ...
          return (
            ...
            o.push(this.maybeBlock(n.body, u & Q ? we : ee)),
            o
          );
        },
        ForInStatement: function (n, u) {
          return this.generateIterationForStatement('in', n, u & Q ? we : ee);
        },
        ForOfStatement: function (n, u) {
          return this.generateIterationForStatement('of', n, u & Q ? we : ee);
        },
        LabeledStatement: function (n, u) {
          return [n.label.name + ':', this.maybeBlock(n.body, u & Q ? we : ee)];
        },
...
`
      ...
      (oe.Expression = {
              ...
              : ((l = [n.operator]),
                n.operator.length > 2
                  ...
                  : ((T = K(l).toString()),
                    ...
                    (((P === 43 || P === 45) && P === w) ||
                      (c.code.isIdentifierPartES5(P) && c.code.isIdentifierPartES5(w))) &&
                      l.push(fe()),
                    l.push(d))),
            le(l, r.Unary, u)
          );
        ...
        FunctionExpression: function (n, u, o) {
          ...
          return (
            n.id ? (l.push(St(n) || fe()), l.push(ge(n.id))) : l.push(St(n) || v),
        ...
        ClassExpression: function (n, u, o) {
          ...
          return (
            ...
            n.superClass &&
              ...
              (l = U(l, d))),
            l.push(v),
            l.push(this.generateStatement(n.body, we)),
            l
          );
        },
        ...
        ObjectPattern: function (n, u, o) {
          ...
          if (((T = !1), n.properties.length === 1))
            ...
            for (d = 0, w = n.properties.length; d < w; ++d)
              if (((P = n.properties[d]), P.type === t.Property && !P.shorthand)) {
                T = !0;
                break;
              }
          return (
    ...
    : e < 91
      ...
      : e < 97
        ...
        : e < 123
          ? !0
          : e <= 65535
            ? e >= 170 && Is.test(String.fromCharCode(e))
            : t === !1
              ? !1
              : ur(e, Ii);
}
        ...
        : e < 91
          ...
          : e < 97
            ...
            : e < 123
              ? !0
              : e <= 65535
                ? e >= 170 && Ps.test(String.fromCharCode(e))
                : t === !1
                  ? !1
                  : ur(e, Ii) || ur(e, Ns);
}
...
function Rs(e) {
  ...
  return ni(t.onComment) && (t.onComment = Fs(t, t.onComment)), t;
}
function Fs(e, t) {
  return function (r, i, s, a, c, f) {
    var p = { type: r ? 'Block' : 'Line', value: i, start: s, end: a };
    e.locations && (p.loc = new dt(this, c, f)), e.ranges && (p.range = [s, a]), t.push(p);
  };
}
var ct = 1,
  mt = 2,
...
var si = 0,
  ...
  re = function (t, r, i) {
    (this.options = t = Rs(t)),
      ...
      (this.keywords = Ue(ks[t.ecmaVersion >= 6 ? 6 : t.sourceType === 'module' ? '5module' : 5]));
    var s = '';
    if (t.allowReserved !== !0) {
      for (var a = t.ecmaVersion; !(s = nr[a]); a--);
      t.sourceType === 'module' && (s += ' await');
    }
    this.reservedWords = Ue(s);
    var c = (s ? s + ' ' : '') + nr.strict;
    (this.reservedWordsStrict = Ue(c)),
      (this.reservedWordsStrictBind = Ue(c + ' ' + nr.strictBind)),
      (this.input = String(r)),
      (this.containsEsc = !1),
      i
        ? ((this.pos = i),
...
me.strictDirective = function (e) {
  for (;;) {
    ...
    var t = Ms.exec(this.input.slice(e));
    if (!t) return !1;
...
z.parseTryStatement = function (e) {
  if ((this.next(), (e.block = this.parseBlock()), (e.handler = null), this.type === h._catch)) {
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Ri : 0), this.checkLVal(t.param, r ? Di : Ne), this.expect(h.parenR);
...
z.parseVarId = function (e, t) {
  (e.id = this.parseBindingAtom()), this.checkLVal(e.id, t === 'var' ? _r : Ne, !1);
};
var ot = 1,
  lr = 2,
  ji = 4;
z.parseFunction = function (e, t, r, i) {
  this.initFunction(e),
    ...
    t & ot &&
      ((e.id = t & ji && this.type !== h.name ? null : this.parseIdent()),
      e.id &&
        !(t & lr) &&
        this.checkLVal(
          e.id,
          this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? _r : Ne) : Bi,
        ));
  var s = this.yieldPos,
    a = this.awaitPos,
...
z.parseExport = function (e, t) {
  ...
  if (this.eat(h._default)) {
    ...
    if (this.type === h._function || (r = this.isAsyncFunction())) {
      var i = this.startNode();
      this.next(), r && this.next(), (e.declaration = this.parseFunction(i, ot | ji, !1, r));
...
z.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = Ds), (e.source = this.parseExprAtom()))
    ...
    case 'Identifier':
      t === Ne &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        t !== si && t !== Vi && this.declareName(e.name, t, e.start);
      break;
    case 'ChainExpression':
      this.raiseRecoverable(e.start, 'Optional chaining cannot appear in left-hand side');
      break;
...
W.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(Sr(t, i.generator) | Fi | (r ? Mi : 0)),
    this.expect(h.parenL),
...
W.parseFunctionBody = function (e, t, r) {
  ...
  if (i) (e.body = this.parseMaybeAssign()), (e.expression = !0), this.checkParams(e, !1);
    ...
    (this.labels = []),
      ...
      this.strict && e.id && this.checkLVal(e.id, Vi),
...
De.declareName = function (e, t, r) {
  ...
  if (t === Ne) {
    ...
    for (var f = this.scopeStack.length - 1; f >= 0; --f) {
      ...
      if (
        (p.lexical.indexOf(e) > -1 && !(p.flags & Ri && p.lexical[0] === e)) ||
...
De.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & br && !(t.flags & Oi)) return t;
  }
};
...
var Ui =
  ...
  Gs = Wi + ' Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho',
  zs = { 9: zi, 10: Wi, 11: Gs },
  $i = {};
function Cr(e) {
  var t = ($i[e] = {
    binary: Ue(Us[e] + ' ' + ai),
    nonBinary: { General_Category: Ue(ai), Script: Ue(zs[e]) },
  });
...
var j = re.prototype,
  Re = function (t) {
    (this.parser = t),
      ...
      (this.unicodeProperties = $i[t.options.ecmaVersion >= 11 ? 11 : t.options.ecmaVersion]),
      (this.source = ''),
      (this.flags = ''),
      (this.start = 0),
      (this.switchU = !1),
...
j.regexp_eatPatternCharacters = function (e) {
  for (var t = e.pos, r = 0; (r = e.current()) !== -1 && !Ji(r); ) e.advance();
  return e.pos !== t;
};
...
j.regexp_eatRegExpIdentifierStart = function (e) {
  ...
  return (
    ...
    Ws(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function Ws(e) {
...
j.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    e.advance(r),
    i === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, r) && (i = e.lastIntValue),
    $s(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function $s(e) {
...
j.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
  ...
  if (e.eat(117)) {
    ...
    if (i && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && Js(e.lastIntValue))
      return !0;
...
j.regexp_eatCharacterClassEscape = function (e) {
  var t = e.current();
  if (Xs(t)) return (e.lastIntValue = -1), e.advance(), !0;
...
j.regexp_eatUnicodePropertyName = function (e) {
  var t = 0;
  for (e.lastStringValue = ''; Hi((t = e.current())); ) (e.lastStringValue += Tt(t)), e.advance();
...
j.regexp_eatUnicodePropertyValue = function (e) {
  var t = 0;
  for (e.lastStringValue = ''; Hs((t = e.current())); ) (e.lastStringValue += Tt(t)), e.advance();
  return e.lastStringValue !== '';
};
function Hs(e) {
  return Hi(e) || Bt(e);
...
j.regexp_eatHexDigits = function (e) {
  ...
  for (e.lastIntValue = 0; Qi((r = e.current())); )
    (e.lastIntValue = 16 * e.lastIntValue + Yi(r)), e.advance();
  return e.pos !== t;
};
function Qi(e) {
...
j.regexp_eatFixedHexDigits = function (e, t) {
  ...
  for (var i = 0; i < t; ++i) {
    var s = e.current();
    if (!Qi(s)) return (e.pos = r), !1;
    (e.lastIntValue = 16 * e.lastIntValue + Yi(s)), e.advance();
  }
  return !0;
};
var Dt = function (t) {
...
$.readRadixNumber = function (e) {
  ...
  return (
    ...
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((r = Zi(this.input.slice(t, this.pos))), ++this.pos)
...
$.readNumber = function (e) {
  ...
  if (!r && !e && this.options.ecmaVersion >= 11 && i === 110) {
    var s = Zi(this.input.slice(t, this.pos));
    return (
      ++this.pos,
      Le(this.fullCharCodeAtPos()) && this.raise(this.pos, 'Identifier directly after number'),
  ...
  r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    Le(this.fullCharCodeAtPos()) && this.raise(this.pos, 'Identifier directly after number');
  var a = Qs(this.input.slice(t, this.pos), r);
...
var sa = Si,
  ...
  ca = Object.prototype,
  nn = la.toString,
  ha = ca.hasOwnProperty,
  fa = nn.call(Object);
function pa(e) {
  if (!oa(e) || sa(e) != ua) return !1;
  var t = aa(e);
  if (t === null) return !0;
  var r = ha.call(t, 'constructor') && t.constructor;
  return typeof r == 'function' && r instanceof r && nn.call(r) == fa;
}
var da = pa,
  ma = Si,
  ga = zn,
  ...
  va = '[object String]';
function xa(e) {
  return typeof e == 'string' || (!ga(e) && ya(e) && ma(e) == va);
}
var ba = xa; /*!
...
function Sa(e) {
  ...
  return ui(e) === !1
    ...
    : ((t = e.constructor),
      t === void 0
        ? !0
        : ((r = t.prototype), !(ui(r) === !1 || r.hasOwnProperty('isPrototypeOf') === !1)));
}
var sn = {},
  It =
    (lt && lt.__assign) ||
    ...
    var f =
      ...
      p
        .map(function (g, b) {
          ...
          return s.transform && (I = s.transform(e, g, I)), a.indent + String(v) + ': ' + I + E;
        })
        .join('') +
      a.pad +
      '}';
...
Z.ContextConsumer = Gt;
Z.ContextProvider = Ut;
Z.Element = kr;
Z.ForwardRef = zt;
Z.Fragment = Vt;
Z.Lazy = Xt;
...
var on = function (t) {
  ...
  Va = function e(t) {
    switch (!0) {
      ...
      case t.$$typeof === Ee.Memo:
        return e(t.type);
      case t.$$typeof === Ee.ForwardRef:
        return e(t.render);
      default:
        return un(t);
    }
  ...
  ja = function (t) {
    switch (!0) {
      ...
      case typeof t.type == 'function':
        return t.type.displayName ? t.type.displayName : un(t.type);
      case Ee.isForwardRef(t):
      case Ee.isMemo(t):
        return Va(t.type);
      case Ee.isContextConsumer(t):
        return ''.concat(t.type._context.displayName || 'Context', '.Consumer');
      case Ee.isContextProvider(t):
        return ''.concat(t.type._context.displayName || 'Context', '.Provider');
      case Ee.isLazy(t):
        return 'Lazy';
      case Ee.isProfiler(t):
        return 'Profiler';
      case Ee.isStrictMode(t):
        return 'StrictMode';
      case Ee.isSuspense(t):
        return 'Suspense';
      default:
  ...
  Ir = function e(t, r) {
    ...
    if (typeof t == 'number') return Fa(t);
    ...
    return Da && t.type === ze.Fragment ? Ba(f, y) : Ma(a, c, p, y);
  };
function Ua() {}
var Ga = function (t) {
    return t
  ...
  za = function (e, t, r, i) {
    ...
    return t
      ? a
          ...
          .replace(/\[ /g, '[')
          .replace(/ ]/g, ']')
      : a.replace(/\t/g, Pe(1, i.tabStop)).replace(
          /\n([^$])/g,
          `
`.concat(Pe(r + 1, i.tabStop), '$1'),
        );
  },
  Wa = function (t) {
    return t.replace(/"/g, '&quot;');
  ...
  $a = function (t, r, i, s) {
    ...
    if (typeof t == 'string') return '"'.concat(Wa(t), '"');
    if (ht(t) === 'symbol') {
      var a = t
        .valueOf()
        .toString()
    ...
    return typeof t == 'function'
      ? '{'.concat(ln(t, s), '}')
      : ze.isValidElement(t)
        ? '{'.concat(Ht(Ir(t, s), !0, i, s), '}')
        : t instanceof Date
          ? isNaN(t.valueOf())
            ? '{new Date(NaN)}'
            : '{new Date("'.concat(t.toISOString(), '")}')
          : Sa(t) || Array.isArray(t)
            ? '{'.concat(za(t, r, i, s), '}')
            : '{'.concat(String(t), '}');
  },
  Ja = function (e, t, r, i, s, a, c, f) {
    if (!t && !i)
      throw new Error(
  ...
  Xa = function (e, t) {
    ...
    return (
      ...
      (i.type === 'string' || i.type === 'number')
        ? r.push(on(String(i.value) + String(t.value)))
        : (i && r.push(i), r.push(t)),
      r
    );
  },
...
`,
          ...
          .map(function (f, p) {
            return p === 0 ? f : ''.concat(Pe(s, c)).concat(f);
          }).join(`
`)
      : r;
  },
  ...
  cn = function (t, r, i, s, a) {
    return a ? Pe(i, s).length + r.length > a : t.length > 1;
  },
  to = function (t, r, i, s, a, c, f) {
    return (cn(t, r, a, c, f) || i) && !s;
  },
  hn = function (e, t, r, i) {
    var s = e.type,
      a = e.displayName,
    ...
    if (
      (_.forEach(function (B) {
        var R = Ja(B, Object.keys(y).includes(B), y[B], Object.keys(b).includes(B), b[B], t, r, i),
...
`),
  ...
  ao = function (e, t, r, i) {
    ...
    var f = i.useFragmentShortSyntax,
      p;
    return f ? (so(e) || no(e) ? (p = pi) : (p = ro)) : (p = pi), hn(io(p, a, c), t, r, i);
  },
  oo = ['<', '>', '{', '}'],
  uo = function (t) {
    return oo.some(function (r) {
      return t.includes(r);
    });
  },
  lo = function (t) {
    return uo(t) ? '{`'.concat(t, '`}') : t;
  },
  co = function (t) {
    var r = t;
    return (
  ...
  Ht = function (e, t, r, i) {
    ...
    if (e.type === 'string') return e.value ? ''.concat(co(lo(String(e.value)))) : '';
    if (e.type === 'ReactElement') return hn(e, t, r, i);
    if (e.type === 'ReactFragment') return ao(e, t, r, i);
...
const { defaultDecorateStory: fo, addons: po, useEffect: mo } = __STORYBOOK_MODULE_PREVIEW_API__,
...
var fn = { format: { indent: { style: '  ' }, semicolons: !1 } },
  bo = { ...fn, format: { newline: '' } },
  So = { ...fn };
function Me(e, t = !1) {
  return Ei.generate(e, t ? bo : So);
}
function dr(e, t = !1) {
  return t ? _o(e) : Me(e);
}
...
function Eo(e) {
  let t = Me(e);
  return t.endsWith('  }]') && (t = es(t)), t;
}
function Co(e) {
  let t = Me(e, !0);
  return t.startsWith('[    ') && (t = t.replace('[    ', '[')), t;
}
var pn = (e) => e.$$typeof === Symbol.for('react.memo'),
  Ao = (e) => e.$$typeof === Symbol.for('react.forward_ref'),
  Lr = { ...N, JSXElement: () => {} },
  wo = re.extend(ia());
function yt(e) {
...
function Po(e) {
  ...
  return (
    ...
    { inferredType: { type: t != null ? 'Element' : 'Class', identifier: yt(e.id) }, ast: e }
  );
}
function No(e) {
  let t = { type: 'Element' },
...
function Lo(e) {
  ...
  return yt(t) === 'shape' ? mn(e.arguments[0]) : null;
}
function mn(e) {
  return { inferredType: { type: 'Object', depth: dn(e) }, ast: e };
}
function Oo(e) {
  return { inferredType: { type: 'Array', depth: dn(e) }, ast: e };
}
function Ro(e) {
  switch (e.type) {
    case 'Identifier':
...
function yn(e, t) {
  ...
  switch (s) {
    ...
    case 'Element': {
      let { identifier: p } = r;
      (a = p != null && !Nr(p) ? p : tt), (c = gi(e).length === 1 ? e : null), (f = e);
      break;
    }
    case 'Array': {
      let { depth: p } = r;
      (a = Pr), (c = p <= 2 ? yi(i, !0) : null), (f = yi(i));
      break;
    }
    default:
      (a = Bo(s)), (c = gi(e).length === 1 ? e : null), (f = e);
      break;
  }
  return de({ name: t, short: a, compact: c, full: f, inferredType: s });
}
function Do({ raw: e }) {
  return e != null ? yn(e, 'custom') : de({ name: 'custom', short: pr, compact: pr });
}
function Vo(e) {
  let { jsDocTags: t } = e;
  return t != null && (t.params != null || t.returns != null)
    ? de({
        name: 'func',
        short: yo(t.params, t.returns),
        compact: null,
        full: go(t.params, t.returns),
      })
...
function Go({ value: e, computed: t }) {
  return t ? yn(e, 'enumvalue') : de({ name: 'enumvalue', short: e, compact: e });
}
function zo(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, i) => {
        let { short: s, compact: a, full: c } = Go(i);
...
function xi(e, t, r) {
  return de({ name: 'arrayOf', short: mr(e), compact: t != null ? vi(t) : null, full: r && vi(r) });
}
function Wo(e, t) {
  let { name: r, short: i, compact: s, full: a, inferredType: c } = Ze(e.value, t);
  if (r === 'custom') {
    if (c === 'Object') return xi(i, s, a);
    ...
    switch (t.name) {
      ...
      case 'func': {
        let { short: r, full: i } = Ze(t, e),
          s = r,
          a;
        return i && i.length < Mo ? (s = i) : i && (a = vo(i)), te(s, a);
      }
      default:
        return null;
    }
...
function xn({ inferredType: e, ast: t }) {
  let { depth: r } = e;
  if (r <= 2) {
    let i = di(t, !0);
    if (!ft(i)) return te(i);
...
function Jo({ inferredType: e, ast: t }) {
  let { identifier: r } = e;
  if (r != null) return te(bn(e), Me(t));
  let i = Me(t, !0);
...
var Yo = (e) => {
    if (_n(e) && e.type != null) return Qo(e);
    if (da(e)) {
  ...
  Zo = (e) => te(e.toString()),
  Cn = { string: Ho, object: Yo, function: Ko, default: Zo };
function eu(e = {}) {
  return { ...Cn, ...e };
}
function An(e, t, r = Cn) {
  try {
    switch (typeof e) {
      case 'string':
        return r.string(e, t);
...
function su(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    i = e.map((s) => nu(s, r[s.propDef.name]));
  return tu(i, t);
}
function au(e, t) {
  let { propDef: r } = e,
...
function uu(e, t) {
  let r = e;
  !Hn(e) && !e.propTypes && pn(e) && (r = e.type);
  let i = Qn(r, t);
...
var hu = (e, t) => {
    ...
    for (let a = 0; a < t.skip; a += 1) {
      ...
      if (at.Children.count(r) > 1) return Ct.warn('Trying to skip an array of elements'), null;
      ...
      ...(typeof t.displayName == 'string'
        ...
        : {
            displayName: (a) =>
              ...
              Xn(a.type, 'displayName') ||
              (a.type.name !== '_default' ? a.type.name : null) ||
              (typeof a.type == 'function' ? 'No Display Name' : null) ||
              (Ao(a.type) ? a.type.render.name : null) ||
              (pn(a.type) ? a.type.type.name : null) ||
              a.type,
          }),
...
`,
  ...
  fu = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  pu = (e) => {
    var i;
  ...
  wn = (e) => {
    ...
    let { mdxType: t, originalType: r, children: i, ...s } = e.props,
      a = [];
    return i && (a = (Array.isArray(i) ? i : [i]).map(wn)), ze.createElement(r, s, ...a);
  },
  kn = (e, t) => {
    var g, b;
    let r = po.getChannel(),
    ...
    mo(() => {
      if (!i) {
        ...
        r.emit(Jn, { id: E, source: s, args: S });
      }
    });
    let a = e();
    if (i) return a;
    let c = { ...fu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      f =
  ...
  bu = (e, t) => {
    let r = t.findIndex((s) => s.originalFn === kn),
      i = r === -1 ? t : [...t.splice(r, 1), ...t];
    return fo(e, i);
  },
  Su = { docs: { story: { inline: !0 }, extractArgTypes: cu, extractComponentDescription: Wn } },
  _u = [kn],
  Eu = [$n];
export { bu as applyDecorators, Eu as argTypesEnhancers, _u as decorators, Su as parameters };
