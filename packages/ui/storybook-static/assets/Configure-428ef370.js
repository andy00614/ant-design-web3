import { u as o } from './index-4fb8b842.js';
import { M as a } from './index-db1f4591.js';
import { j as e } from './jsx-runtime-ccada58e.js';
...
const n = '' + new URL('github-cdfc3270.svg', import.meta.url).href,
  c = '' + new URL('discord-f7d1b78c.svg', import.meta.url).href,
  d = '' + new URL('youtube-9f26eb0b.svg', import.meta.url).href,
  l = '' + new URL('tutorials-adff6365.svg', import.meta.url).href,
  g = '' + new URL('styling-c83082e0.png', import.meta.url).href,
  m = '' + new URL('context-c612d889.png', import.meta.url).href,
  h =
  ...
  p = '' + new URL('docs-5b0c7100.png', import.meta.url).href,
  b = '' + new URL('share-b59d6c77.png', import.meta.url).href,
  x = '' + new URL('figma-plugin-b0a5ad2d.png', import.meta.url).href,
  j = '' + new URL('testing-6a59f681.png', import.meta.url).href,
  u = '' + new URL('accessibility-cd6d60f7.png', import.meta.url).href,
  f = '' + new URL('theming-b6e819c3.png', import.meta.url).href,
  R = '' + new URL('addon-library-bc7ba705.png', import.meta.url).href,
  s = () => {
...
function r(t) {
  const i = Object.assign({ h1: 'h1', p: 'p', code: 'code' }, o(), t.components);
          ...
          e.jsxs('div', {
            ...
            children: [
              ...
              e.jsxs('div', {
                className: 'sb-section-item',
                children: [
                  e.jsx('img', { src: h, alt: 'A representation of typography and image assets' }),
                  e.jsxs('div', {
                    children: [
                      e.jsx('h4', {
                        className: 'sb-section-item-heading',
...
interactive reference documentation from your components and stories.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: x, alt: 'Windows showing the Storybook plugin in Figma' }),
...
implementation in one place.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: j, alt: 'Screenshot of tests passing and failing' }),
...
complex.`,
                ...
                e.jsxs('div', {
                  className: 'sb-grid-item',
                  children: [
                    e.jsx('img', { src: f, alt: 'Screenshot of Storybook in light and dark mode' }),
      ...
      e.jsxs('div', {
        ...
        children: [
          ...
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: d, alt: 'Youtube logo', className: 'sb-explore-image' }),
              e.jsxs('div', {
                children: [
          ...
          e.jsxs('div', {
            className: 'sb-section-item',
            children: [
              e.jsx('img', { src: l, alt: 'A book', className: 'sb-explore-image' }),
...
export { s as RightArrow, Q as default };
