                ...
                : Te === '[object Map]'
                  ...
                  : Te === '[object Set]'
                    ...
                    : ae || y(g)
                      ? `[${d(g)}]`
                      : `${
                          oe || (!F.printBasicPrototype && d(g) === 'Object') ? '' : `${d(g)} `
...
${Te}`,
          ...
          var I = (g) =>
              L.reduce((F, W) => {
                let X = g.theme && g.theme[W] !== void 0 ? g.theme[W] : ue[W],
                  V = X && t.default[X];
            ...
            me = (g) => ({
              ...
              escapeRegex: ne(g),
              escapeString: pe(g),
              indent: g?.min ? '' : se(g?.indent ?? R.indent),
          ...
          var t = 'diff-sequences',
            ...
            c = (d, y, S, _, O, C, N, j, k, T, E) => {
              let A = _ - y,
                ...
                B = r,
                ue = d < j ? d : j;
              for (let L = 0, ee = -d; L <= ue; L += 1, ee += 2) {
                let R = L === 0 || (L !== d && B < N[L]),
                  M = R ? N[L] : B,
                  I = R ? M : M + 1,
                  K = A + I - ee,
                ...
                if (((B = N[L]), (N[L] = ne), D <= ee && ee <= G)) {
                  ...
                  if (pe <= T && k[pe] - 1 <= ne) {
                    ...
                    (E.nChangePreceding = d - 1),
                      ...
                      (E.nCommonPreceding = se),
                      se !== 0 && ((E.aCommonPreceding = Ee), (E.bCommonPreceding = g)),
                ...
                if (((B = k[L]), (k[L] = ne), D <= ee && ee <= G)) {
                  ...
                  if (pe <= j && ne - 1 <= N[pe]) {
                    ...
                    if (
                      ...
                      let se = A + M - (R ? ee - 1 : ee + 1),
                        fe = n(M, S, se, O, C);
                      (E.nCommonFollowing = fe),
                        fe !== 0 && ((E.aCommonFollowing = M), (E.bCommonFollowing = se));
                      let we = M + fe,
                        Ee = se + fe;
                      d - 1 === S + O - we - Ee
                        ? ((E.aStartFollowing = S), (E.bStartFollowing = O))
            ...
            m = (d, y, S, _, O, C, N, j, k) => {
              ...
              if (((N[0] = y - 1), (j[0] = S), z % 2 === 0)) {
                ...
                let B = ((d || z) + 1) / 2,
                  ue = (A + q + 1) / 2,
                  L = 1;
                for (D = u(L, S, O, T, C, N, D), L += 1; L <= ue; L += 1)
            ...
            h = (d, y, S, _, O, C, N, j, k, T) => {
              if (O - _ < S - y) {
                if (((C = !C), C && N.length === 1)) {
                  ...
                  N[1] = {
                    foundSubsequence: (se, fe, we) => {
                      pe(se, we, fe);
                    },
                    isCommon: (se, fe) => me(fe, se),
                  };
                }
                let Z = y,
                  ne = S;
    ...
    var Xt = (e) => Array.isArray(e) || (ArrayBuffer.isView(e) && !(e instanceof DataView)),
      ...
      vt = (e) => {
        ...
        let y = (R) => {
          ...
          { isChild: G, depth: B, hasHover: ue } = i.useContext(Dt),
          L = ue ? r : !1;
        if (!G)
          return i.createElement(
            'ul',
