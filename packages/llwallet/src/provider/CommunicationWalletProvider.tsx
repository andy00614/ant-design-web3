...
import { NAME_OF_STORAGE_CLEAR, walletTokenName } from '../const';
import { StorageEventEnum, useWalletPostMessageListener, walletStorageChangeSender } from '../sync';
...
function CommunicationWalletProvider(props: CommunicationWalletProviderProps) {
...
export default CommunicationWalletProvider;
